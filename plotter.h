...
public:
     ...
     */
        ...
        void shape(int sh);
        /**
         * @brief sculptor é o Sculptor chamado pela primeira vez quando o programa é aberto;
         */
        Sculptor *sculptor;
        /**
         * @brief method é a forma de desenho escolhida pelo usuário. PutVoxel está definida como padrão;
         */
        int method;
        /**
        ...
        int dim;
        /**
         * @brief plan é o plano selecionado pelo usuário;
         */
        int plan;
        /**
